    ...
    return (
        <section className="flex flex-col items-center justify-center min-h-screen p-6">
            <div className="w-full max-w-md flex flex-col gap-6">
                ...
                <Link className="flex items-center gap-4 justify-center sm:justify-start" href="/">
                ...
                <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
                    ...
                    <Button
                        type="submit"
                        disabled={loading}
                        className="w-full h-12 bg-purple-600 text-white hover:bg-purple-700 disabled:opacity-60"
                    >
