...
export default function HeroSection() {
    return (
        <section className="flex flex-col justify-center items-center h-screen gap-8 px-4 text-center">

            <div className="flex items-center gap-2 bg-gray-200 px-4 py-2 text-xs rounded-full">
                <Sparkles className="w-4 h-4 text-purple-500" />
                <span>Sistema de gerenciamento profissional</span>
            </div>
